...
function AddMaster() {
    ...
    const [errors, setErrors] = useState<{ username?: string; password?: string; points?: string; mobile?: string }>({});
    ...
    const validate = () => {
        ...
        else if (!/^[0-9]{10}$/.test(mobile)) newErrors.mobile = "Enter valid 10-digit number";
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className={`w-full pl-10 pr-3 py-2 rounded-lg border bg-white/70 focus:outline-none focus:ring-2 transition ${errors.mobile
                                ? "border-red-500 focus:ring-red-400"
                                : "border-slate-300 focus:ring-blue-500"
                                }`}
                        />
